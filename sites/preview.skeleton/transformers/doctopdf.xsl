...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:import href="util/html2fo.xsl"/>
  		...
  		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
		    ...
		    <fo:layout-master-set>
		    	<fo:simple-page-master master-name="main" page-width="8.5in" page-height="11in" margin-left="1in" margin-right="1in" margin-top="0in" margin-bottom="0.5in">
		        	<fo:region-body margin-top="2.2in" margin-bottom="0.25in"/>
	   		...
	   		<fo:page-sequence master-reference="main" initial-page-number="1">
				...
				<fo:static-content flow-name="xsl-region-before">
					...
					<fo:block-container absolute-position="absolute" left="200pt" top="10pt" z-index="2">
						<fo:block>
							<fo:external-graphic src="resources/images/entete.jpg" vertical-align="middle"/> 
						</fo:block>
					</fo:block-container>
			    </fo:static-content>
				...
				<fo:static-content flow-name="xsl-region-after">
			       	...
			       	Nouvelle Polyclinique du Borinage - Page <fo:page-number/> / <fo:page-number-citation  ref-id="theEnd" />
			       	</fo:block>
			    </fo:static-content>
				...
				<fo:flow flow-name="xsl-region-body">
					...
					<xsl:for-each select="kmehrmessage/header/recipient/hcparty[familyname!='']">
				       	<fo:block-container font-size="12pt" top="0pt" margin-right="20pt" height="60pt">
	       			...
	       			<fo:block font-size="12pt" font-family="sans-serif" line-height="14pt" text-align="left" padding-top="0pt" margin-left="110pt">
	       			...
	       			<fo:block font-size="12pt" font-family="sans-serif" line-height="20pt" space-before="10pt" space-after="10pt" text-align="right" padding-top="0pt">
			        	Colfontaine, le 
	       			...
	       			<fo:block font-weight="bold" font-size="13pt" font-family="sans-serif" line-height="20pt" space-before="10pt" space-after="10pt" text-align="left" padding-top="0pt">
			        	Concerne :
			       ...
			       <fo:block font-size="12pt" font-family="sans-serif" line-height="15pt" space-after="3pt" text-align="start">
			       		<xsl:apply-templates select="kmehrmessage/folder/transaction/text/node()"/>
			       </fo:block>

	       			<fo:block font-size="12pt" font-family="sans-serif" line-height="15pt" space-before="10pt" space-after="10pt" text-align="right" padding-top="0pt">
